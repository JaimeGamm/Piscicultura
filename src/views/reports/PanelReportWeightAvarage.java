...
public class PanelReportWeightAvarage  extends JPanel{
	private static final long serialVersionUID = 1L;
	private HashMap<String, Double> percentajeOfSpeciesPriceInBoyaca;

    public PanelReportWeightAvarage(HashMap<String, Double> percentajeOfSpeciesPriceInBoyaca) throws IOException, DeserializationException {
    ...
    public void paint(Graphics g){
        super.paint(g);
            ...
            int long_red = ((int)(double)percentajeOfSpeciesPriceInBoyaca.get(TypeSpecie.BOCACHICO.getName())+100);
            int long_green = ((int)(double)percentajeOfSpeciesPriceInBoyaca.get(TypeSpecie.CACHAMA.getName())+100);
            int long_blue = ((int)(double)percentajeOfSpeciesPriceInBoyaca.get(TypeSpecie.CARPA.getName())+100);
            int long_orange = ((int)(double)percentajeOfSpeciesPriceInBoyaca.get(TypeSpecie.RTRUCHA.getName())+100);
            int long_yellow = ((int)(double)percentajeOfSpeciesPriceInBoyaca.get(TypeSpecie.TILAPIA_NEGRA.getName())+100);
            int long_pink = ((int)(double)percentajeOfSpeciesPriceInBoyaca.get(TypeSpecie.TILAPIA_O_MOJARRA.getName())+100);
            int long_gray = ((int)(double)percentajeOfSpeciesPriceInBoyaca.get(TypeSpecie.TILAPIA_O_MOJARRA_ROJA.getName())+100);
            int long_cian = ((int)(double)percentajeOfSpeciesPriceInBoyaca.get(TypeSpecie.TRUCHA.getName())+100);
            int long_magenta = ((int)(double)percentajeOfSpeciesPriceInBoyaca.get(TypeSpecie.UCACHAMA.getName())+100);
            int long_black = ((int)(double)percentajeOfSpeciesPriceInBoyaca.get(TypeSpecie.UTILAPIA_NEGRA.getName())+100);
            int long_lightGray = ((int)(double)percentajeOfSpeciesPriceInBoyaca.get(TypeSpecie.UTILAPIA_O_MOJARRA.getName())+100);
